...
<aside class="pwa-drawer-content" id="pwaDrawerContent">
    ...
    <a href="logout.php?redirect=pwa-admin.php" onclick="if(window.cerrarSesionPwa){ event.preventDefault(); window.cerrarSesionPwa('/login.php?redirect=pwa-admin.php'); }" class="pwa-drawer-item" style="color: #EF4444; margin-top: 10px; border-top: 1px solid var(--border-pwa); padding-top: 14px;">
