...
<body>
    <div class="login-container">
        ...
        <?php else: ?>
            ...
            <p class="login-subtitle">Inicia sesión para acceder a tu cuenta y agendar citas.</p>

            <?php if ($error): ?>
                <div class="alert-box alert-danger">⚠️ <?php echo htmlspecialchars($error); ?></div>
            <?php endif; ?>

            <!-- Botón de Google PRIMERO ARRIBA -->
            ...
            <p style="font-size: 0.85rem; color: #374151; margin-bottom: 1.1rem; line-height: 1.45; text-align: left; font-weight: 600;">
                Si no tienes cuenta de Google, inicia sesión con tu perfil creado por administrador:
            </p>
